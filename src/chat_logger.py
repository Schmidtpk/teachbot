"""
IID-CHAT-LOG, IID-SHEETS-LOG, SID-PRIVACY-DATA
...
_HEADER_ROW = ["timestamp", "session_id", "role", "content"]


class SheetsLogger:
    """Append chat turns as rows to a Google Sheet (IID-SHEETS-LOG, SID-PRIVACY-DATA).
    ...
    def __init__(self, sheet_id: str, session_id: str) -> None:
    ...
    def _append(self, role: str, content: str) -> None:
        ...
        try:
            ...
            ts = datetime.now(timezone.utc).isoformat()
            ws.append_row(
                [ts, self._session_id, role, content],
