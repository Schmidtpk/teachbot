...
4. **Push back** when arguments are weak, double-count existing evidence, or reflect reasoning biases (e.g., availability heuristic, base rate neglect, overconfidence, anchoring).
